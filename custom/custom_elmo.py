...
class CustomElmo(torch.nn.Module):
    """
    ...
    def forward(self,    # pylint: disable=arguments-differ
                ...
                word2vec_embeddings: torch.Tensor = None,) -> Dict[str, Union[torch.Tensor, List[torch.Tensor]]]:
        """
        Parameters
        ----------
        ...
        layer_activations.append(word2vec_embeddings)
...
class ElmoTokenEmbedder(TokenEmbedder):
    ...
    def __init__(self,
        ...
        self._elmo = CustomElmo(options_file,
                          weight_file,
                          1,
                          do_layer_norm=do_layer_norm,
                          dropout=dropout,
    ...
    def forward(self, # pylint: disable=arguments-differ
                inputs: torch.Tensor,
                word_inputs: torch.Tensor = None,
                word2vec_embeddings: torch.Tensor = None) -> torch.Tensor:
        """
        Parameters
        ----------
        inputs: ``torch.Tensor``
        ...
        """
        elmo_output = self._elmo(inputs, word_inputs, word2vec_embeddings)
