...
class CustomTextFieldEmbedder(TextFieldEmbedder):
    ...
    def __init__(self,
        ...
        super(CustomTextFieldEmbedder, self).__init__()
    ...
    def forward(self,
        ...
        for key in keys:
            ...
            token_vectors = embedder(*tensors, word2vec_embeddings=word2vec_embeddings)
            embedded_representations.append(token_vectors)
        return torch.cat(embedded_representations, dim=-1)

    # This is some unusual logic, it needs a custom from_params.
    @classmethod
    def from_params(cls, vocab: Vocabulary, params: Params) -> 'CustomTextFieldEmbedder':  # type: ignore
